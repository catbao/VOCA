...
async function computeMultyOrSingle(table,columns, func, width,height, mode, symble, parallel, errorBound,screenStart,screenEnd,screen_m4){
...
async function ours(table_name,columns,symble,params,width,height,mode,parallel,errorBound,startTime,endTime, interact_type,screen_m4){

    //console.log(table_name,columns,symble,params,width,height,mode,parallel,errorBound,startTime,endTime, interact_type,screen_m4)
    ...
    await computeMultyOrSingle(table,columns, funInfo, width,height, mode, symble, parallel, errorBound,startTime,endTime,screen_m4)
...
async function Case5(table_name,columns,symbol,params,width,height,mode,parallel,errorBound,startTime,endTime, interact_type,screen_m4){
    ...
    console.log(influxUrl,token,org,bucket)
...
async function getcolumns(req, res){
  ...
  WHERE table_schema = 'public' AND table_name = '${table_name}' and column_name like 'v%';
`
    console.log(sql)
    let result = await pool.query(sql)
...
class M4_Client{
    constructor(i,st,sv,min,max,et,ev){
        this.i=i
        this.st = st;
        this.sv = sv;
        this.min = min;
...
async function start(req, res){
    ...
    console.log(table_name,columns,symbol,'',width,height,mode,parallel,errorBound,startTime,endTime, interact_type)
    ...
    switch(experiment){
        case 'ours':
            ...
            await ours(table_name,columns,symbol,'',width,height,mode,parallel,errorBound,startTime,endTime, interact_type,screen_m4)
            break; 
        case 'case1':
            startTime = Number(startTime)
            endTime = Number(endTime)
